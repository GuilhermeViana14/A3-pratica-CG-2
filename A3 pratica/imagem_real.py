...
def processar_imagem(caminho):
    ...
    img_suavizada = aplicar_filtro_suavizacao(imagem)
    mostrar_imagem(img_suavizada)
    gerar_histograma(img_suavizada)
    cv2.waitKey(0)
    
    img_equalizada = aplicar_filtro_equalizacao_histograma(imagem)
    mostrar_imagem(img_equalizada)
    gerar_histograma(img_equalizada)
    
def main():
    caminhos = ["A3-pratica-CG-2-main/A3 pratica/imagem_real/img1.jpg", "A3-pratica-CG-2-main/A3 pratica/imagem_real/img2.jpg", "A3-pratica-CG-2-main/A3 pratica/imagem_real/img3.jpeg", "A3-pratica-CG-2-main/A3 pratica/imagem_real/img4.jpg", "A3-pratica-CG-2-main/A3 pratica/imagem_real/img5.png" ]
